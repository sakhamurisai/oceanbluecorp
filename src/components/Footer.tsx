...
const socialLinks = [
  { name: "LinkedIn", href: "https://linkedin.com/company/oceanbluecorp", icon: Linkedin, color: "hover:bg-blue-600" },
  { name: "Twitter", href: "https://twitter.com/oceanbluecorp", icon: Twitter, color: "hover:bg-sky-500" },
  { name: "YouTube", href: "https://youtube.com/oceanbluecorp", icon: Youtube, color: "hover:bg-red-600" },
  { name: "GitHub", href: "https://github.com/oceanbluecorp", icon: Github, color: "hover:bg-gray-900" },
  { name: "Instagram", href: "https://instagram.com/oceanbluecorp", icon: Instagram, color: "hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500" },
];
